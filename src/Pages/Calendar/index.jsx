    ...
    <Page>
      <div>
        ...
        <div className="flex mb-[50px] flex-wrap lg:flex-nowrap gap-10 justify-between rounded-[200px] mt-20 opacity-80">
          ...
          <div className="flex mt-2 md:mt-[90px] items-center w-full lg:w-[50%] h-[70px] rounded-full border border-transparent bg-transparent overflow-hidden">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 h-full w-[50%] xv:w-[full] p-4  xv:px-8 border-none bg-[transparent] text-[12px] xv:text-lg font-['Poppins'] font-normal leading-[30px] outline-none z-[1] placeholder:font-normal placeholder:text-[12px] xv:placeholder:text-lg placeholder:leading-[30px]"
            />
            <button className="h-full w-[40%] xv:w-[full] bg-gradient-to-r from-[#8A38EE] to-[#D64FED] font-['Plus_Jakarta_Sans'] text-white text-base font-bold p-0 xv:px-8 border-none cursor-pointer rounded-tr-full rounded-br-full z-[1] hover:opacity-90 transition-all duration-300">
              Subscribe
            </button>
          </div>
        </div>
